...
MARKET_HELPER_FILE := lib/config/utils/market_helper.dart
...
set-google-play:
	...
	@sed -i '' -E "s|return AppLnksConst\\.otherAppsRustoreLink;|return AppLnksConst.otherAppsGooglePlayLink;|" $(MARKET_HELPER_FILE)
...
set-rustore:
	...
	@sed -i '' -E "s|return AppLnksConst\\.otherAppsGooglePlayLink;|return AppLnksConst.otherAppsRustoreLink;|" $(MARKET_HELPER_FILE)
	@$(MAKE) --no-print-directory show-market
