      ...
      body: SafeArea(
        child: BlurredScrollView(
          ...
          children: [
            ...
            BulletPointText(contentText: S.of(context).unoFlipTurnRuleDrawCard),
            BulletPointText(contentText: S.of(context).unoFlipTurnRuleFlipCard),
            const SizedBox(height: 15),
            Text(
            ...
            BulletPointText(contentText: S.of(context).unoFlipLightSideDrawOne),
            BulletPointText(contentText: S.of(context).unoFlipLightSideReverse),
            BulletPointText(
            ...
            BulletPointText(contentText: S.of(context).unoFlipDarkSideDrawFive),
            BulletPointText(contentText: S.of(context).unoFlipDarkSideReverse),
            BulletPointText(contentText: S.of(context).unoFlipDarkSideSkipAll),
            BulletPointText(contentText: S.of(context).unoFlipDarkSideWildCard),
            BulletPointText(
            ...
            BulletPointText(contentText: S.of(context).unoFlipKeyMomentUnoCall),
            const SizedBox(height: 15),
            Text(
            ...
            BulletPointText(contentText: S.of(context).unoFlipVictory500Points),
            BulletPointText(
                contentText:
