      ...
      body: SafeArea(
        child: BlurredScrollView(
          ...
          children: [
            ...
            BulletPointText(contentText: S.of(context).unoActiveCardSkipTurn),
            BulletPointText(contentText: S.of(context).unoActiveCardDrawTwo),
            BulletPointText(contentText: S.of(context).unoActiveCardReverse),
            ...
            BulletPointText(contentText: S.of(context).unoSpecialRuleUnoCall),
            BulletPointText(contentText: S.of(context).unoSpecialRuleReshuffle),
            const SizedBox(height: 15),
            Text(
              S.of(context).unoScoringTitle,
              style: theme.display2.copyWith(color: theme.redColor),
            ),
            Text(S.of(context).unoScoringNumberCards, style: theme.display2),
            BulletPointText(contentText: S.of(context).unoScoring20PointsCards),
            BulletPointText(contentText: S.of(context).unoScoring50PointsCards),
            BulletPointText(contentText: S.of(context).unoScoring40PointsCards),
            const SizedBox(height: 15),
            Text(
            ...
            BulletPointText(
                contentText: S.of(context).unoVictoryLowestScoreAlternative),
            const SizedBox(height: 20),
            Text(
